...
namespace Extly\Jean85;

use Composer\InstalledVersions;
use Extly\Jean85\Exception\ProvidedPackageException;
use Extly\Jean85\Exception\ReplacedPackageException;
use Extly\Jean85\Exception\VersionMissingExceptionInterface;
