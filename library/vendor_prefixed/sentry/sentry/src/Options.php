...
use Extly\Sentry\Integration\ErrorListenerIntegration;
use Extly\Sentry\Integration\IntegrationInterface;
use Extly\Symfony\Component\OptionsResolver\Options as SymfonyOptions;
...
final class Options
{
    ...
    private function configureOptions(OptionsResolver $resolver): void
    {
        ...
        $resolver->setAllowedTypes('integrations', ['Extly\\Sentry\\Integration\\IntegrationInterface[]', 'callable']);
